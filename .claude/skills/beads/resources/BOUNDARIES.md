...
- [Boundaries: When to Use bd vs TodoWrite](#boundaries-when-to-use-bd-vs-todowrite)
  - [Contents](#contents)
  - [The Core Question](#the-core-question)
  - [Decision Matrix](#decision-matrix)
    - [Use bd for:](#use-bd-for)
      - [Multi-Session Work](#multi-session-work)
      - [Complex Dependencies](#complex-dependencies)
      - [Knowledge Work](#knowledge-work)
      - [Side Quests](#side-quests)
      - [Project Memory](#project-memory)
    - [Use TodoWrite for:](#use-todowrite-for)
      - [Single-Session Tasks](#single-session-tasks)
      - [Linear Execution](#linear-execution)
      - [Immediate Context](#immediate-context)
      - [Simple Tracking](#simple-tracking)
  - [Detailed Comparison](#detailed-comparison)
  - [Integration Patterns](#integration-patterns)
    - [Pattern 1: bd as Strategic, TodoWrite as Tactical](#pattern-1-bd-as-strategic-todowrite-as-tactical)
    - [Pattern 2: TodoWrite as Working Copy of bd](#pattern-2-todowrite-as-working-copy-of-bd)
    - [Pattern 3: Transition Mid-Session](#pattern-3-transition-mid-session)
  - [Real-World Examples](#real-world-examples)
    - [Example 1: Database Migration Planning](#example-1-database-migration-planning)
    - [Example 2: Simple Feature Implementation](#example-2-simple-feature-implementation)
    - [Example 3: Bug Investigation](#example-3-bug-investigation)
    - [Example 4: Refactoring with Dependencies](#example-4-refactoring-with-dependencies)
  - [Common Mistakes](#common-mistakes)
    - [Mistake 1: Using TodoWrite for Multi-Session Work](#mistake-1-using-todowrite-for-multi-session-work)
    - [Mistake 2: Using bd for Simple Linear Tasks](#mistake-2-using-bd-for-simple-linear-tasks)
    - [Mistake 3: Not Transitioning When Complexity Emerges](#mistake-3-not-transitioning-when-complexity-emerges)
    - [Mistake 4: Creating Too Many bd Issues](#mistake-4-creating-too-many-bd-issues)
    - [Mistake 5: Never Using bd Because TodoWrite is Familiar](#mistake-5-never-using-bd-because-todowrite-is-familiar)
    - [Mistake 6: Always Asking Before Creating Issues (or Never Asking)](#mistake-6-always-asking-before-creating-issues-or-never-asking)
